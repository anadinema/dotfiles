...
# Install tmux plugin manager if not already present, needed for the tmux plugins to work
...
# Install/setup smaller tit-bits for different tools
__install_other_tools() {
